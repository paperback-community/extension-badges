...
type ContentTranslation = {
    /** Flawless translation with excellent typesetting. No errors, reads naturally. */
    Best: SourceBadge;
    /** Mostly accurate translation with minimal errors. Typesetting is well-done and easy to read. */
    Good: SourceBadge;
    /** Noticeable translation mistakes or poor typesetting that affect readability. */
    Bad: SourceBadge;
    /** Machine-translated content with significant errors, awkward phrasing, and no typesetting. */
    Machine: SourceBadge;
